...
<body>
	...
	<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
		<!-- Verifica se é um usuario authenticado ou não, para mostrar diferentes mensagens -->
		<h1><?php if ($user["auth"]) { echo("Esse usúario não pode acessar essa pagina"); }else{ echo("Faça Login para acessar essa página"); } ?></h1>	
	</div>
	<!--===============================================================================================-->
