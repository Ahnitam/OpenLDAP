...
if (!$user["auth"] || $user["group"] != "gerentes") {
...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarScroll">
				<ul class="navbar-nav">
					...
					<?php if ($user["group"] == "gerentes") { echo('<li class="nav-item"><a class="nav-link disabled">Gerenciar</a></li>'); } ?>
	...
	<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
		<div class="container text-center">
			<div class="row"><h1>Área de Gerenciamento</h1></div>
		</div>	
	</div>
	<!--===============================================================================================-->
